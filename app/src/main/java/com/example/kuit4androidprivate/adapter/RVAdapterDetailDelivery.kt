...
class RVAdapterDetailDelivery (
    private val context: Context,
    private val items: ArrayList<DetailMenuData>,
) : RecyclerView.Adapter<RVAdapterDetailDelivery.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: RVAdapterDetailDelivery.ViewHolder, position: Int) {
