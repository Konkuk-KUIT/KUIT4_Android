...
class DetailTogoRVAdapter (
    private val context : Context,
    private val items: ArrayList<DishData>
): RecyclerView.Adapter<DetailTogoRVAdapter.ViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DetailTogoRVAdapter.ViewHolder {
        val binding =
    ...
    override fun onBindViewHolder(holder: DetailTogoRVAdapter.ViewHolder, position: Int) {
